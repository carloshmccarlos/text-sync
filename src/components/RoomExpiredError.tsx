				...
				<div className="text-center space-y-6">
					...
					<div>
						...
						<p className="text-gray-600 dark:text-gray-300 mb-4">
							This room (ID: <code className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-sm">{roomId}</code>) has expired. 
							Rooms are automatically deleted after 24 hours for security and storage reasons.
						</p>
					</div>
