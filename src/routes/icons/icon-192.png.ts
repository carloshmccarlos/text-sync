...
// 1x1 transparent PNG placeholder. Replace with a real 192x192 PNG in public/icons to remove this route.
...
export const ServerRoute = createServerFileRoute("/icons/icon-192/png").methods({
  GET: serve,
});
