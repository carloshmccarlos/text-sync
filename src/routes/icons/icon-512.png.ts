...
// 1x1 transparent PNG placeholder. Replace with a real 512x512 PNG in public/icons to remove this route.
...
export const ServerRoute = createServerFileRoute("/icons/icon-512/png").methods({
  GET: serve,
});
